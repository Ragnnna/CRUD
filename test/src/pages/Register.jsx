...
const Register = () => {
    ...
    const handleCheckbox = () => {
        setCheckboxToggle(state => state = !state)
            ...
            <form className="register-form">
                <div className="form-control">
                    <label htmlFor="username">
                        ...
                        value={user.username}
                        className="form-element input-text input-style" type="text" name="username" id="username" 
                        />
                    </label>
                </div>
                <div className="form-control">
                    <label htmlFor="email">
                        ...
                        onChange={changeHandler} 
                        value={user.email} 
                        className="form-element input-text input-style" type="text" name="email" id="email" 
                        />
                    </label>
                </div>
                <div className="form-control">
                ...
                <div className="form-control">
                    <label onClick={handleCheckbox} htmlFor="" className="custom-checkbox" style={{'background': !checkboxToggle ? 'black' : "#E5E5E5"}}>
                        <input 
                        ref={checkRef}
                        value={user.isAdmin} 
                        className="checkbox-register" type="checkbox" name="isAdmin" id="" 
                        />
                    </label>
